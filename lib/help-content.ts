...
const GROUPS: ReadonlyArray<readonly [string, readonly FaqPair[]]> = [
  ...
  ['Suppliers & Partnerships', [
    ...
    ['Are you an authorized reseller?', 'Authorization is specific to each supplier or brand relationship. Auronix Commerce does not claim blanket authorization for every brand. We can provide and follow written authorization requirements when a relationship is approved.'],
    ['Do you comply with MAP policies?', 'Auronix Commerce follows applicable written minimum advertised price policies and other agreed brand requirements. Suppliers should provide their current policy and notify Auronix of approved updates.'],
    ['What documents can you provide to suppliers?', 'Available verification may include published company registration information and relevant business or resale documentation for an appropriate due-diligence review. Document availability depends on the relationship and the sensitivity of the request.'],
    ['What are your typical order quantities?', 'Order quantities depend on the product, demand, case pack, pricing, lead time, and the approved supplier relationship. Auronix does not publish one standard quantity for every supplier.'],
    ['How does Auronix protect brand integrity?', 'Auronix supports brand integrity through accurate product information, agreed channel and pricing controls, supplier coordination, documented sourcing, and attention to applicable marketplace and brand requirements.'],
  ...
  ['Marketplace Operations', [
    ...
    ['Which marketplaces do you currently sell on?', 'Auronix Commerce supports marketplace operations involving Amazon, Walmart, and eBay. Specific channel activity and product availability depend on the approved brand, supplier relationship, account eligibility, and each marketplace’s current rules.'],
